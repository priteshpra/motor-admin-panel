...
class SettingsController extends Controller {
  protected $handle_name = "settings";
  ...
  public function index() {
    ...
    $dashboard_cards = [
      ['Category', $cat, Route('admin.categorys.index'), 'fa fa-dashboard'],
      ['Sub-category', $subcat, Route('admin.subcategorys.index'), 'fa fa-calendar'],
    //   ['Cordinate', 0, Route('admin.cordinate.index'), 'fa fa-dashboard'],
    ...
    return kview('settings', compact('dashboard_cards', 'module_names'));
  }
